...
const DownloadScreen = ({ 
  audio, isMenuOpen, toggleMenu, activeTab, tabs, currentUser, handleTabPress, toggleHeart, likedSongs, setCurrentScreen, handleLogout, handleOpenAuth, handleOpenSearch, downloadedSongs, toggleDownload,
  dynamicPlaylist
}: any) => {
                ...
                return (
                  ...
                  >
                    <View style={localStyles.downloadIconContainer}>
                      <Ionicons name="checkmark-circle" size={20} color="#0CD2D1" />
                    </View>
