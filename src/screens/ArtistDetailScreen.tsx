  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={localStyles.heroSection}>
          ...
          <View style={localStyles.heroContent}>
            ...
            <View style={localStyles.heroActions}>
              <TouchableOpacity style={localStyles.playBtn} onPress={() => artistSongs.length > 0 && navigateToPlayer(artistSongs[0].id)}>
        ...
        {/* --- Top Songs Section --- */}
        <View style={[localStyles.section, { paddingHorizontal: 20 }]}>
            ...
            artistSongs.map((track: any, index: number) => (
              ...
              >
                ...
                <TouchableOpacity onPress={() => toggleHeart(track.id)}>
                  <Ionicons name={likedSongs[track.id] ? "heart" : "heart-outline"} size={22} color={likedSongs[track.id] ? "#0CD2D1" : "#8E97A6"} />
                </TouchableOpacity>
