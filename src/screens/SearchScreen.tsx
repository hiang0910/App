  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={localStyles.searchHeader}>
        ...
        <Animated.View entering={FadeInDown.duration(400)} style={[localStyles.searchBarContainer, { backgroundColor: 'rgba(255,255,255,0.05)', overflow: 'hidden' }]}>
          <TextInput 
            ref={searchInputRef}
      ...
      <View style={{ flex: 1 }}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          {!lowercaseQuery ? (
            <Animated.View entering={FadeInUp.delay(200)} style={localStyles.emptyState}>
            ...
            <View>
              ...
              {artistResults.length > 0 && (
                <Animated.View entering={FadeInDown.duration(500)} style={localStyles.sectionContainer}>
                  ...
                  <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 16 }}>
                    {artistResults.map((artist, idx) => (
                      <Animated.View key={idx} entering={FadeInRight.delay(idx * 100).duration(400)}>
                        ...
                        >
                          <Image source={{ uri: artist.image }} style={[localStyles.artistImage, { borderColor: THEME.primary, borderWidth: 1 }]} />
              ...
              {albumResults.length > 0 && (
                <Animated.View entering={FadeInDown.delay(200).duration(500)} style={localStyles.sectionContainer}>
              ...
              {songResults.length > 0 && (
                <Animated.View entering={FadeInDown.delay(400).duration(500)} style={localStyles.sectionContainer}>
                      ...
                      <Animated.View key={item.id} entering={FadeInDown.delay(index * 50).duration(400)}>
                        ...
                        >
                          ...
                          <TouchableOpacity onPress={() => toggleHeart(item.id)}>
                            <Ionicons name={likedSongs[item.id] ? "heart" : "heart-outline"} size={22} color={likedSongs[item.id] ? THEME.primary : THEME.textSecondary} />
                          </TouchableOpacity>
                        </TouchableOpacity>
                      </Animated.View>
                    ))}
